...
class MemberRepositoryTest {
    ...
    public void paging() {
        ...
        // when
        Page<Member> page = memberRepository.findByAge(age, pageRequest);  // api 반환 불가
    ...
    public void bulkUpdate() {
        ...
        // when
        int resultCount = memberRepository.bulkAgePlus(20);  // 3
//        em.clear();
    ...
    public void findMemberLazy() {
        ...
        for (Member member : members) {
            ...
            System.out.println("member.team = " + member.getTeam().getName());  // select
        }
    }
